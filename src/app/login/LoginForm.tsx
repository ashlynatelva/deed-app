    ...
    >
      <div className="w-full max-w-[420px]">
        ...
        <div className="flex flex-col items-center mb-7 text-white">
          {/* Brokerage logo if uploaded; otherwise the DEED platform
              monogram rendered inline as SVG. The inline mark renders
              crisply at any pixel density (no asset dependency, no
              raster scaling) and is the only surface that gets the
              premium-scale hero treatment. Sidebar / drawer / invite /
              branding-preview still use /logo.png at compact sizes. */}
